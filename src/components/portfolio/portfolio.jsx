    ...
    <section id='portfolio'>
      ...
      <div className="container portfolio__container">
        ...
        <article className="portfolio__item">
          ...
          <h3>Forja</h3>
          <div className="portfolio__item-cta">
            <a href="https://github.com/medcharfeddine/MovieAppProject" className='btn' target='_blank'>Github</a>
            <a href="https://movie-app-project-nu.vercel.app/" className='btn btn-primary' target='_blank'>Live Demo</a>
          </div>
        </article>
        <article className="portfolio__item">
          <div className="portfolio__item-image">
